...
* Change: [cnpAPI v12.50]: For existing transaction `vendorCredit` the base type is changed from `transactionTypeWithReportGroup` to `transactionTypeWithReportGroupAndRtp`.
* Change: Compatible with JDK 21.

## Change Log for 12.49.0_jdk17 (April 17, 2026)
* Change: Added ANT commands to enable support for Integer values in enumeration definitions
* Change: Updated Java version compatibility to Java 21. Source & Target compatibility is set to version 17.
...
## Version 12.33.0 (v12.32 & v12.33)(December 7, 2023)
...
## Version 12.0.0 (December 7, 2017)
...
## Version 8.16.0 (February 1, 2013)

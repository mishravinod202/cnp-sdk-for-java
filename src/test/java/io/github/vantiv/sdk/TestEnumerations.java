...
public class TestEnumerations {
	...
	public void customerType() {
		...
		info.setCustomerType(CustomerInfo.CustomerType.EXISTING);
	}

	@Test
	public void residenceStatus() {
		CustomerInfo info = new CustomerInfo();
		info.setResidenceStatus(CustomerInfo.ResidenceStatus.OWN);
	}

	@Test
	public void deliveryType() {
		EnhancedData info = new EnhancedData();
		info.setDeliveryType(EnhancedData.DeliveryType.CNC);
	}
